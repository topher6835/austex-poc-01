            ...
            <form name="get-quote" method="POST" className="content-description">
              ...
              <div className="quote-form-basic-info-section ">
                ...
                <MDBRow>
                  ...
                  <MDBCol md="4">
                    ...
                    >
                      ...
                      <option
                        value="- I don&#039;t have a Sales Rep - "
                        className=""
                      >
                ...
                <MDBRow>
                  <MDBCol md="4">
                    ...
                    >
                      ...
                      <option
                        value="Booklet or multi page leaflet"
                        className=""
                      >
                ...
                <MDBRow>
                  ...
                  <MDBCol md="3">
                    <label htmlFor="perforations" className="">
                      Do you require perforations?
                      <span className="frm_required"></span>
                    </label>
                    <select
                      className="browser-default custom-select"
                  ...
                  <MDBCol md="3">
                    <label htmlFor="printingType" className="">
                      What kind of printing do you require?
                      <span className="frm_required"></span>
                    </label>
                    <select
                      className="browser-default custom-select"
              ...
              <div className="quote-form-color-section">
                ...
                <MDBRow>
                  <MDBCol md="3">
                    <label htmlFor="processColors" className="">
                      Process colors
                      <span className="frm_required"></span>
                    </label>
                    <select
                  ...
                  <MDBCol md="3">
                    <label htmlFor="spotColors" className="">
                      Spot colors
                      <span className="frm_required"></span>
                    </label>
                    <select
                  ...
                  <MDBCol md="3">
                    <label htmlFor="foilEmboss" className="">
                      Foil or Emboss?
                      <span className="frm_required"> *</span>
                    </label>
                    <select
                  ...
                  <MDBCol md="3">
                    <label htmlFor="varnish" className="">
                      Varnish
                      <span className="frm_required"> *</span>
                    </label>
                    <select
              ...
              <div className="quote-form-paper-bindery-section">
                ...
                <MDBRow>
                  <MDBCol md="4">
                    <label htmlFor="coverPaper" className="">
                      Cover Paper
                      <span className="frm_required"> *</span>
                    </label>
                    <select
                  ...
                  <MDBCol md="4">
                    <label htmlFor="textPaper" className="">
                      Text Paper
                      <span className="frm_required"> *</span>
                    </label>
                    <select
                  ...
                  <MDBCol md="4">
                    <label htmlFor="folding" className="">
                      Folding
                      <span className="frm_required"> *</span>
                    </label>
                    <select
                ...
                <MDBRow>
                  <MDBCol md="4">
                    <label htmlFor="finishedPageSize" className="">
                      Finished Page Size
                      <span className="frm_required"></span>
                    </label>
                    <input
                      ...
                      type="text"
                      id="finishedPageSize"
                      name="finishedPageSize"
                    />
                  </MDBCol>
                  <MDBCol md="4">
                    <label htmlFor="dieCut" className="">
                      Die Cut
                      <span className="frm_required"> *</span>
                    </label>
                    <select
                  ...
                  <MDBCol md="4">
                    <label htmlFor="bindery" className="">
                      Bindery
                      <span className="frm_required"> *</span>
                    </label>
                    <select
              ...
              <div className="quote-form-delivery-section">
                <MDBRow>
                  <MDBCol md="6">
                    ...
                    >
                      ...
                      <option value="Deliver to address supplied" className="">
                        Deliver to address supplied
                      </option>
                      <option value="This is a direct mail piece" className="">
                        This is a direct mail piece
                      </option>
                  ...
                  <MDBCol md="6">
                    <label htmlFor="packaging" className="">
                      Packaging
                      <span className="frm_required"></span>
                    </label>
                    <select
              ...
              <div className="quote-form-design-files-section">
                <h3 className="">Design/Data Files</h3>
                <MDBRow>
                  <MDBCol md="6">
                    <label htmlFor="fileFormat" className="">
                      File Format
                      <span className="frm_required"></span>
                    </label>
                    <select
                  ...
                  <MDBCol md="6">
                    <label htmlFor="sendingVia" className="">
                      Sending via
                      <span className="frm_required"></span>
                    </label>
                    <select
                ...
                <MDBRow>
                  <MDBCol md="12">
                    <label htmlFor="additionalInfo" className="">
              ...
              <div className="quote-form-receive-info-section">
                <MDBRow>
                  <MDBCol md="4">
                    <label className="">
                      Receive occasional news &amp; offers from Aus-Tex
                      <span className="frm_required"> *</span>
                    </label>
                    <MDBRow>
                      <MDBCol md="6">
                        <input
                          ...
                          defaultChecked
                        />{' '}
                        <label htmlFor="receiveNewsYes">Yes, please!</label>
                      </MDBCol>
                      <MDBCol md="6">
                        <input
                          type="radio"
                          ...
                          value="No"
                        />{' '}
                        <label htmlFor="receiveNewsNo">No thanks.</label>
                      </MDBCol>
                    </MDBRow>
                  </MDBCol>
                </MDBRow>
              ...
              <div className="mt-4">
                <MDBBtn className="quote-submit-button" type="submit">
                  Submit
                </MDBBtn>
              </div>
            </form>
